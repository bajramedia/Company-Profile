...
export default function SosialMediaManagementPage() {
    const { t } = useLanguage();
                                ...
                                <div className="absolute top-full left-0 mt-2 w-64 bg-white dark:bg-gray-800 rounded-xl shadow-lg border border-gray-100 dark:border-gray-700 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 z-50">
                                    <div className="p-2">
                                        ...
                                        <Link href="/services/sosial-media-management" className="flex items-center space-x-3 px-3 py-2 rounded-lg bg-green-50 dark:bg-green-900/20 text-green-600 dark:text-green-400">
                                            ...
                                            <div>
                                                <div className="font-medium text-sm">Social Media Management</div>
                                                <div className="text-xs opacity-70">Kelola media sosial bisnis</div>
                                            </div>
                                        </Link>
                                    </div>
                                </div>
            ...
            <div className="pt-20 pb-6 bg-gray-50 dark:bg-gray-800">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-8">
                    <nav className="flex items-center space-x-2 text-sm">
                        ...
                        <span className="text-gray-400">→</span>
                        <span className="text-green-500 font-medium">Social Media Management</span>
                    </nav>
                </div>
            </div>
            ...
            <main className="py-16">
                ...
                <section className="max-w-7xl mx-auto px-4 sm:px-6 md:px-8 mb-20">
                    <div className="text-center mb-12">
                        <h2 className="text-3xl font-bold text-gray-900 dark:text-white mb-4">Platform Social Media</h2>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                        <div className="bg-white dark:bg-gray-800 rounded-xl p-6 text-center border border-gray-100 dark:border-gray-700">
                            ...
                            <p className="text-gray-600 dark:text-gray-400 text-sm">Feed, Stories, Reels & IGTV</p>
                        </div>
                        <div className="bg-white dark:bg-gray-800 rounded-xl p-6 text-center border border-gray-100 dark:border-gray-700">
                            <div className="text-3xl mb-3">🎵</div>
                            <h3 className="font-semibold text-gray-900 dark:text-white mb-2">TikTok</h3>
                            <p className="text-gray-600 dark:text-gray-400 text-sm">Video viral & trending content</p>
                        </div>
                        <div className="bg-white dark:bg-gray-800 rounded-xl p-6 text-center border border-gray-100 dark:border-gray-700">
                            <div className="text-3xl mb-3">👔</div>
                ...
                <section className="max-w-7xl mx-auto px-4 sm:px-6 md:px-8 mb-20">
                    <div className="text-center mb-12">
                        <h2 className="text-3xl font-bold text-gray-900 dark:text-white mb-4">Paket Social Media Management</h2>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                        <div className="bg-white dark:bg-gray-800 rounded-2xl p-8 border border-gray-100 dark:border-gray-700 flex flex-col h-full">
                            <div className="flex-grow">
                                ...
                                <div className="mb-6">
                                    <span className="text-3xl font-bold text-green-500">3jt</span>
                        ...
                        <div className="bg-white dark:bg-gray-800 rounded-2xl p-8 border-2 border-green-500 relative flex flex-col h-full">
                            ...
                            <div className="flex-grow">
                                ...
                                <p className="text-gray-600 dark:text-gray-400 mb-6">Untuk bisnis yang berkembang</p>
                                <div className="mb-6">
                                    <span className="text-3xl font-bold text-green-500">6jt</span>
                                    <span className="text-gray-500">/bulan</span>
                                </div>
                                <ul className="space-y-2 mb-8 text-sm">
                                    <li className="flex items-center">
                        ...
                        <div className="bg-white dark:bg-gray-800 rounded-2xl p-8 border border-gray-100 dark:border-gray-700 flex flex-col h-full">
                            <div className="flex-grow">
                                ...
                                <p className="text-gray-600 dark:text-gray-400 mb-6">Untuk brand besar</p>
                                <div className="mb-6">
                                    <span className="text-3xl font-bold text-green-500">12jt</span>
                                    <span className="text-gray-500">/bulan</span>
                                </div>
                                <ul className="space-y-2 mb-8 text-sm">
                                    <li className="flex items-center">
                    ...
                    <div className="relative bg-gray-900 dark:bg-gray-800 rounded-3xl p-12 text-center text-white overflow-hidden">
                        ...
                        <div className="relative z-10">
                            <h2 className="text-3xl md:text-4xl font-bold mb-4 text-white">
                                Siap Boost Engagement Brand Kamu?
                            </h2>
                            <p className="text-xl opacity-90 mb-8 max-w-2xl mx-auto leading-relaxed">
                                Audit gratis media sosial kamu sekarang. Dapatkan strategi content dan insight dari social media expert!
                            </p>
                            <div className="flex flex-col sm:flex-row gap-4 justify-center">
