                ...
                <div className="max-w-7xl mx-auto flex justify-between items-center px-4 sm:px-6 md:px-8">
                    ...
                    <div className="hidden md:flex items-center space-x-7">
                        <nav className="flex space-x-6">
                            ...
                            <Link href="/services" className="text-gray-700 dark:text-gray-300 hover:text-primary transition-colors">Services</Link>
                            <Link href="/portfolio" className="text-primary transition-colors">Portfolio</Link>
                            <Link href="/blog" className="text-gray-700 dark:text-gray-300 hover:text-primary transition-colors">Blog</Link>
                        </nav>
                ...
                <section className="max-w-7xl mx-auto px-4 sm:px-6 md:px-8">
                    ...
                    <div className="text-center py-16" data-aos="fade-up">
                        ...
                        <p className="text-gray-600 dark:text-gray-400 mb-6">
                            Kami sedang menambahkan project-project keren lainnya
                        </p>
                        <Link href="/portfolio">
