                        ...
                        <div className="lg:col-span-2">
                            ...
                            <div className="space-y-4">
                                ...
                                <div className="flex space-x-4">
                                    ...
                                    {!loading && publicSettings?.socialLinks?.github && (
                                        <a href={publicSettings.socialLinks.github} target="_blank" rel="noopener noreferrer" className="w-10 h-10 bg-gray-800 hover:bg-green-500 rounded-full flex items-center justify-center transition-colors duration-300 group">
                                            <svg className="w-5 h-5 text-gray-400 group-hover:text-white transition-colors" fill="currentColor" viewBox="0 0 24 24">
                                    ...
                                    {!loading && publicSettings?.socialLinks?.discord && (
                                        <a href={publicSettings.socialLinks.discord} target="_blank" rel="noopener noreferrer" className="w-10 h-10 bg-gray-800 hover:bg-green-500 rounded-full flex items-center justify-center transition-colors duration-300 group">
                                            <svg className="w-5 h-5 text-gray-400 group-hover:text-white transition-colors" fill="currentColor" viewBox="0 0 24 24">
                                                <path d="M20.317 4.431c-1.42.545-2.924.908-4.482 1.11a7.126 7.126 0 00-2.646-2.45c-1.488-.97-3.225-1.185-4.912-.6A7.004 7.004 0 004.3 6.943a7.12 7.12 0 00-1.3 4.22v.328c0 2.53.985 4.893 2.684 6.645a9.3 9.3 0 006.182 2.816 9.4 9.4 0 007.41-3.638c1.292-2.023 1.57-4.46 1.04-6.736-.2-.888-.54-1.72-.98-2.45zM9.8 15.11c-.84 0-1.52-.72-1.52-1.6s.68-1.6 1.52-1.6c.84 0 1.52.72 1.52 1.6s-.68 1.6-1.52 1.6zm4.4 0c-.84 0-1.52-.72-1.52-1.6s.68-1.6 1.52-1.6c.84 0 1.52.72 1.52 1.6s-.68 1.6-1.52 1.6z"/>
                                            </svg>
                                        </a>
                                    )}
