                        ...
                        <div className="lg:col-span-2">
                            ...
                            <div className="space-y-4">
                                ...
                                <div className="flex space-x-4">
                                    ...
                                    {publicSettings?.socialLinks?.youtube && (
                                    ...
                                    {/* Fallback GitHub icon if no social links */}
                                    {!publicSettings?.socialLinks?.instagram && !publicSettings?.socialLinks?.facebook && !publicSettings?.socialLinks?.linkedin && !publicSettings?.socialLinks?.twitter && !publicSettings?.socialLinks?.youtube && (
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-center md:text-left">
                        <div className="flex items-center justify-center md:justify-start space-x-3">
                            ...
                            <div>
                                ...
                                <p className="text-white font-medium">{publicSettings?.contactEmail || 'hello@bajramedia.com'}</p>
                            </div>
                        </div>
                        ...
                        <div className="flex items-center justify-center md:justify-start space-x-3">
                            ...
                            <div>
                                ...
                                <p className="text-white font-medium">{publicSettings?.contactPhone || '+6285739402436'}</p>
                            </div>
                        </div>
                        ...
                        <div className="flex items-center justify-center md:justify-start space-x-3">
                            ...
                            <div>
                                ...
                                <p className="text-white font-medium">{publicSettings?.contactAddress || 'Denpasar, Bali'}</p>
                            </div>
                        </div>
                    </div>
                </div>
