                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-left">
                        <div className="flex items-center justify-start space-x-3 text-left">
                            ...
                            <div className="text-left">
                                <p className="text-gray-400 text-sm text-left">{t('Email') || 'Email'}</p>
                        ...
                        <div className="flex items-center justify-start space-x-3 text-left">
                            ...
                            <div className="text-left">
                                <p className="text-gray-400 text-sm text-left">{t('Phone') || 'Phone'}</p>
                                <p className="text-white font-medium text-left">
                        ...
                        <div className="flex items-center justify-start space-x-3 text-left">
                            ...
                            <div className="text-left">
                                <p className="text-gray-400 text-sm text-left">{t('Location') || 'Location'}</p>
                                <p className="text-white font-medium text-left">
