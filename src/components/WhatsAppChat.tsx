...
export default function WhatsAppChat({
  phoneNumber = "6285739402436", // nomor default, bisa diganti
  message = "Halo! Saya tertarik dengan layanan Bajramedia",
  className = ""
}: WhatsAppChatProps) {
  const [isVisible, setIsVisible] = useState(false);

  // animasi muncul setelah page load
  useEffect(() => {
  ...
  return (
    ...
    >
      ...
      <div className="relative group">
        ...
        <div className="absolute -top-1 -right-1 w-5 h-5 bg-green-400 rounded-full border-2 border-white dark:border-gray-900 animate-ping"></div>
        <div className="absolute -top-1 -right-1 w-5 h-5 bg-green-400 rounded-full border-2 border-white dark:border-gray-900"></div>
      </div>
    </div>
  );
} 
